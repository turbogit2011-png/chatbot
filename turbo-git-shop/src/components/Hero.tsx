...
import { Search, Shield, Zap, Truck, Award, ArrowRight, ChevronRight, Star } from "lucide-react";
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Decorative rotating rings — desktop & mobile */}
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-30">
        <div
          className="animate-scan absolute left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#FF7A00]/60 to-transparent"
        />
      </div>
      ...
      >
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-12 items-center w-full">
          ...
          <div className="lg:col-span-3 flex flex-col gap-5">
            ...
            {/* Mini stats — visible on ALL screens */}
            <motion.div
